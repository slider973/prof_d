...
class AdminBottomTabBarController extends StatefulWidget {
  ...
  @override
  _AdminBottomTabBarControllerState createState() => _AdminBottomTabBarControllerState();
}

class _AdminBottomTabBarControllerState extends State<AdminBottomTabBarController> {
  int tabIndex = 0;
