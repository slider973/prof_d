  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Get.theme.focusColor.withOpacity(0.4), blurRadius: 10, offset: Offset(0, -5)),
        ],
      ),
      child: Stack(
        children: <Widget>[
          Padding(
            ...
            child: ListView(
              ...
              children: [
                ExpansionTile(
                  title: Text("Available Doctor".tr, style: Get.textTheme.bodyText2),
                  children: [
                    CheckboxListTile(
...
/*                         setState(() {
                ...
                Obx((){
                  ...
                  return ExpansionTile(
                    title: Text("Specialities".tr, style: Get.textTheme.bodyText2),
