...
import '../modules/tabs/controllers/tabs_controller_.dart';
        ...
        children: [
          Obx(() {
            if (!Get.find<AuthService>().isAuth) {
              ...
              return GestureDetector(
                onTap: () async {
                  await Get.find<TabsController>().changePage(4);
                },
          ...
          DrawerLinkWidget(
            ...
            onTap: (e) {
              Get.back();
              Get.find<TabsController>().changePage(0);
            },
          ),
          DrawerLinkWidget(
          ...
          DrawerLinkWidget(
            ...
            onTap: (e) {
              Get.back();
              Get.find<TabsController>().changePage(1);
            },
          ),
          DrawerLinkWidget(
          ...
          DrawerLinkWidget(
            ...
            onTap: (e) {
              Get.back();
              Get.find<TabsController>().changePage(2);
            },
          ),
          ListTile(
            dense: true,
