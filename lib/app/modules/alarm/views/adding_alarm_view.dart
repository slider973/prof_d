...
class AddAlarmView extends GetView<AlarmsController> {
                  ...
                  Obx((){
                    return Expanded(
                      child: Container(
                          ...
                          child: Text('${DateFormat('HH:mm').format(controller.alarm.value.add_frequencies)}')
                      ),
                    );
                  }),
                  MaterialButton(
                      ...
                      child: Icon(Icons.access_time,color: Get.theme.primaryColor,)
                ...
                children: [
                  Obx((){
                    return Expanded(
                      child: Container(
                          padding: EdgeInsets.only(top: 17, bottom: 17),
                          child: Text('${DateFormat.yMMMd().format(controller.alarm.value.start_from)}')
                      ),
                    );
                  }),
                  MaterialButton(
                      ...
                      elevation: 0,
                      onPressed: () {
                        controller.showMyDatePicker(context,controller.alarm.value.start_from,0);
                      },
                      shape: StadiumBorder(),
                      color: Get.theme.accentColor.withOpacity(0.2),
                ...
                children: [
                  Obx((){
                    return Expanded(
                      child: Container(
                          padding: EdgeInsets.only(top: 17, bottom: 17),
                          child: Text('${DateFormat.yMMMd().format(controller.alarm.value.end_at)}')
                      ),
                    );
                  }),
                  MaterialButton(
